...
class TColor {
  ...
  static const Color inactive = Color(0xff7b7b7b);

  static const Color in2active = Color(0xff8d8d8d);

  static const Color in3active = Color(0xffb1b1b1);

  static const Color holder = Color(0xfff1f1f1);
