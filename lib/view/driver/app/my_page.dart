...
import 'package:tfleet/view/common/my_profile.dart';
      ...
      child: Column(
        children: [
          ...
          _item('assets/image/icon/account.png', AppLocalizations.of(context)?.editProfile ?? 'Edit Profile', onTap: () {
            Navigator.of(context).push(MaterialPageRoute(
              builder: (context) => MyProfile(user: User(account: Global.clientID() ?? '', name: Global.username() ?? '', url: Global.url(), password: Global.password() ?? '', role: 2),),
            ));
          }),
          // _item('assets/image/icon/earnings.png', AppLocalizations.of(context)?.salary ?? 'Salary', onTap: () {
          //   Navigator.of(context).push(MaterialPageRoute(
          //     builder: (context) => SalaryPage(),
          //   ));
          // }),
          // _item('assets/image/icon/payout.png', AppLocalizations.of(context)?.payouts ?? 'Payout', onTap: () {
          //   Navigator.of(context).push(MaterialPageRoute(
