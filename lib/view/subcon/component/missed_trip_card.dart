...
class MissedTripCard extends StatefulWidget {
  const MissedTripCard({Key? key, required this.trip, }) : super(key: key);

  final Trip trip;
  @override
  State<MissedTripCard> createState() => _MissedTripCardState();
}

class _MissedTripCardState extends State<MissedTripCard> {
